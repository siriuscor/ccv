...
__mantaku = Object.assign(__mantaku, {
    ...
    canHandle: function canHandle(url) {
        return (url == 'tw.manhuagui.com' || url == 'www.mhgui.com' || url == 'www.manhuagui.com');
    },
    ...
    mangaInfo: function mangaInfo() {
        return {
            ...
            description: document.querySelector('#intro-cut').innerText,
            ...
            chapters: Array.from(document.querySelectorAll('.chapter-list a')).map(a => {
                return { url: a.href, name: a.title};
            }).reverse()
        };
    },
    search: function search() {
        ...
        return Array.from(list).map(li => {
            ...
            return {
                ...
                intro: li.querySelector('.book-detail .intro').text,
            };
        });
    },
